          ...
          <form className="mt-8 space-y-6" onSubmit={handleSignUp}>
            ...
            <div>
              ...
              <p className="text-xs text-gray-500 mb-2">
                Search for your city or drag the pin to set your primary
                location.
              </p>
              <LocationPicker
            ...
            <div>
              ...
              <div className="flex items-center mt-1 space-x-4">
                ...
                <label
                  htmlFor="file-upload"
                  className="px-3 py-2 text-sm font-medium text-indigo-600 bg-white border border-indigo-600 rounded-md shadow-sm cursor-pointer hover:bg-indigo-50"
                >
