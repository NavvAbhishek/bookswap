          ...
          <div className="grid gap-12 md:grid-cols-3">
            <div className="text-center">
              ...
              <p className="mt-2 text-gray-600">
                Exchange books instead of buying new ones. Keep your wallet
                happy and your bookshelf fresh.
              </p>
            </div>
            <div className="text-center">
              ...
              <p className="mt-2 text-gray-600">
                Connect with book lovers near you and build a community around
                your shared passion for reading.
              </p>
            </div>
            <div className="text-center">
              ...
              <p className="mt-2 text-gray-600">
                Give your books a second life. Swapping is a sustainable choice
                that reduces waste and promotes reuse.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container px-6 mx-auto text-center md:px-12">
          ...
          <div className="grid gap-8 mt-12 md:grid-cols-4">
            <div className="flex flex-col items-center">
              <div className="flex items-center justify-center w-24 h-24 font-bold text-white bg-indigo-600 rounded-full text-3xl">
                1
              </div>
              <h3 className="mt-4 text-lg font-semibold">List Your Books</h3>
              <p className="mt-1 text-sm text-gray-500">
                Take a photo and add details about the books you want to
                exchange.
              </p>
            </div>
            <div className="flex flex-col items-center">
              ...
              <p className="mt-1 text-sm text-gray-500">
                Browse available books near you or get notified about wishlist
                matches.
              </p>
            </div>
            <div className="flex flex-col items-center">
              ...
              <p className="mt-1 text-sm text-gray-500">
                Use our secure chat to agree on a time and public place to swap.
              </p>
            </div>
            <div className="flex flex-col items-center">
              <div className="flex items-center justify-center w-24 h-24 font-bold text-white bg-indigo-600 rounded-full text-3xl">
              ...
              <p className="mt-1 text-sm text-gray-500">
                Meet your swap partner, exchange books, and dive into your next
                adventure.
              </p>
            </div>
          </div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="container px-6 mx-auto md:px-12">
          ...
          <div className="mt-12 text-center">
            <Link
              to="/books"
              className="px-6 py-3 font-semibold text-indigo-600 border-2 border-indigo-600 rounded-lg hover:bg-indigo-600 hover:text-white"
            >
              Browse All Books
            </Link>
          </div>
        ...
        <div className="container px-6 mx-auto md:px-12">
          ...
          <div className="grid gap-8 md:grid-cols-3">
            {testimonials.map((testimonial) => (
              <div
                key={testimonial.id}
                className="p-6 bg-indigo-600 rounded-lg"
              >
                <div className="flex items-center mb-4">
                  <img
                    src={testimonial.imageUrl}
                    alt={testimonial.name}
                    className="w-16 h-16 mr-4 border-2 border-white rounded-full"
                  />
                  <div>
          ...
          <div className="items-center md:flex">
            <div className="md:w-1/2">
              ...
              <p className="mt-4 text-gray-600">
                Our mobile app makes it even easier to discover, list, and swap
                books on the go. Get notified instantly about new matches and
                messages.
              </p>
              <div className="flex mt-8 space-x-4">
                <a
                  href="#"
                  className="flex items-center justify-center w-48 px-4 py-3 bg-gray-800 rounded-lg text-white"
                >
                  <img
                ...
                >
                  <img
                    src="https://upload.wikimedia.org/wikipedia/commons/c/cd/Google_Play_logo.svg"
            ...
            <div className="mt-8 md:mt-0 md:w-1/2">
              <img
                src="https://placehold.co/500x500/ffffff/ffffff?text=."
                alt="Mobile App Mockup"
                className="mx-auto rounded-lg"
                onError={(e) => {
                  e.target.src =
                    "https://images.unsplash.com/photo-1589434193433-5c8291a8e1a7?w=500";
                }}
              />
            </div>
          </div>
          ...
          <div className="grid gap-8 md:grid-cols-4">
            ...
            <div>
              ...
              <p className="mt-4 text-sm">
                Join our newsletter for the latest updates and featured books.
              </p>
