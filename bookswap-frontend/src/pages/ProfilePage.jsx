...
import { UserCircleIcon, PencilSquareIcon, ArrowRightOnRectangleIcon } from '@heroicons/react/24/outline';
                        ...
                        <div className="sm:flex sm:items-center sm:space-x-6">
                            <div className="flex-shrink-0 mb-4 sm:mb-0">
                                {profile.profilePictureUrl ? (
                                    <img className="object-cover w-24 h-24 rounded-full border-4 border-indigo-200" src={profile.profilePictureUrl} alt="Profile" />
                                ) : (
